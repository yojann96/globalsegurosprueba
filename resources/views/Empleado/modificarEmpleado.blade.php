...
<div class="col-lg-10">
  ...
  <form action="{{route('actualizaEmpleado')}}" method="POST" >
    {{csrf_field()}}
      ...
      <div class="form-group col-md-6 row">
        <div class="form-group col-md-6">
          ...
          @endif
          <input type="text" class="form-control" name="nombreEmpleado" id="nombreEmpleado" value="{{$infoEmpleado->nombreEmpleado}}" aria-describedby="nombresHelp" placeholder="Digite nombres">
        ...
        <div class="form-group col-md-6">
          ...
          @endif
          <input type="text" class="form-control" name="apellidoEmpleado" id="apellidoEmpleado" value="{{$infoEmpleado->apellidoEmpleado}}" placeholder="Digite apellidos">
        </div>
      </div>
      ...
      <div class="form-group col-md-6 row">
        <div class="form-group col-md-6">
          ...
          @endif
          <input type="number" class="form-control" name="nroIdentificacionEmpleado" id="nroIdentificacionEmpleado" value="{{$infoEmpleado->nroIdentificacionEmpleado}}" placeholder="Digite identificacion">
        </div>
        <div class="form-group col-md-6">
          ...
          @endif
          <input type="text" class="form-control" name="direccionEmpleado" id="direccionEmpleado" value="{{$infoEmpleado->direccionEmpleado}}" placeholder="Digite dirección">
        </div>
      </div>
      ...
      <div class="form-group col-md-6 row">
        <div class="form-group col-md-6">
          ...
          @endif
          <input type="number" class="form-control" name="nrotelefonoEmpleado" id="nrotelefonoEmpleado" value="{{$infoEmpleado->nrotelefonoEmpleado}}" placeholder="Digite teléfono">
        </div>
      </div>
      ...
      <div class="form-group col-md-6 row">
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-select" name="idDepartamentoEmpleado" id="idDepartamentoEmpleado">
            ...
            <option value="{{$infoEmpleado->idDpartamentoEmpleado}}" selected>{{$infoEmpleado->departamentoEmpleado}}</option>
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-select" name="idCiudadEmpleado" id="idCiudadEmpleado">
            <option value="">Seleccione...</option>
            <option value="{{$infoEmpleado->idCiudadEmpleado}}" selected>{{$infoEmpleado->ciudadEmpleado}}</option>
            @foreach($Ciudades as $Ciudad)
              <option value="{{$Ciudad->idCiudadEmpleado}}" >{{$Ciudad->ciudadEmpleado}}</option>
            @endforeach
          </select>
            </div>
      </div>
      ...
      <br><br>
      <input type="hidden" class="form-control" id="idEmpleado" name="idEmpleado" value="{{$infoEmpleado->IdEmpleado}}" >
