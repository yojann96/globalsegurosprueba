...
<div class="col-lg-10">
  ...
  <form action="<?php echo e(route('guardarEmpleado')); ?>" method="POST" >
    <?php echo e(csrf_field()); ?>
      ...
      <div class="form-group col-md-6 row">
        <div class="form-group col-md-6">
          ...
          <?php endif; ?>
          <input type="text" class="form-control" name="nombreEmpleado" id="nombreEmpleado" value="<?php echo e(old('nombreEmpleado')); ?>" aria-describedby="nombresHelp" placeholder="Digite nombres">
        ...
        <div class="form-group col-md-6">
          ...
          <?php endif; ?>
          <input type="text" class="form-control" name="apellidoEmpleado" id="apellidoEmpleado" value="<?php echo e(old('apellidoEmpleado')); ?>" placeholder="Digite apellidos">
        </div>
      </div>
      ...
      <div class="form-group col-md-6 row">
        <div class="form-group col-md-6">
          ...
          <?php endif; ?>
          <input type="number" class="form-control" name="nroIdentificacionEmpleado" id="nroIdentificacionEmpleado" value="<?php echo e(old('nroIdentificacionEmpleado')); ?>" placeholder="Digite identificacion">
        </div>
        <div class="form-group col-md-6">
          ...
          <?php endif; ?>
          <input type="text" class="form-control" name="direccionEmpleado" id="direccionEmpleado" value="<?php echo e(old('direccionEmpleado')); ?>" placeholder="Digite dirección">
        </div>
      </div>
      ...
      <div class="form-group col-md-6 row">
        <div class="form-group col-md-6">
          ...
          <?php endif; ?>
          <input type="number" class="form-control" name="nrotelefonoEmpleado" id="nrotelefonoEmpleado" value="<?php echo e(old('nrotelefonoEmpleado')); ?>" placeholder="Digite teléfono">
        </div>
      </div>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelProyectos\grupoAlianza-Prueba\resources\views/Empleado/formularioEmpleado.blade.php ENDPATH**/ ?>